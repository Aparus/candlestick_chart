...
angular.module('quotesApp')
    .controller('IndexController', ['$scope', 'quotesFactory',
        function($scope, quotesFactory) {
            ...
            quotesFactory.getQuotes()
                .then(
                    function(response) {
                        ...
                        // we need two data sets: for Candles chart and Volumes chart, whith same dates by axisX and different by axisY
                        $scope.dataPointsCandles = $scope.quotes.map(
                            function(elem, index) {
                                return {
                                    x: new Date(elem.yyyy, elem.mm, elem.dd, elem.hh, elem.mn, elem.ss),
            ...
            //creates and shows two charts , one above another  
            ...
            // syncronization between two charts: Candles and Volumes, when we zoom and go through them 
